...
#   The integrated analysis tests enrichment for chromatin carrying one or more
#   of the assayed histone marks. It is NOT, by itself, a direct genome-wide
#   nucleosome/histone-retention assay. A nucleosome-retention dataset should be
#   analyzed separately if the manuscript makes a direct "histone retention"
#   claim.
################################################################################
